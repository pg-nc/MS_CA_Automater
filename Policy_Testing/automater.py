...
#graph_client.post(grp_url, json={"description": "SG_ServiceAccounts", "displayName": "SG_ServiceAccounts", "groupTypes": ["Unified"], "mailEnabled": False, "mailNickname": "BaseProtectionGroup", "securityEnabled": True})
